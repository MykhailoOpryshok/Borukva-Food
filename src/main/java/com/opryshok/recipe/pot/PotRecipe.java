...
public record PotRecipe (String group, List<CountedIngredient> input, CountedIngredient bowl, ItemStack output, double time) implements Recipe<PotInput> {
    ...
    public static RecipeEntry<PotRecipe> of(String string, List<CountedIngredient> ingredient, CountedIngredient bowl, ItemStack output, double time) {
        return new RecipeEntry<>(BorukvaFood.id("pot/" + string), new PotRecipe("", ingredient, bowl, output, time));
    }
    @Override
