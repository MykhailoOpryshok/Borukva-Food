...
public class ModFoodComponents {
    ...
    public static final FoodComponent GOLDEN_CHORUS_FRUIT = new FoodComponent.Builder().nutrition(6).saturationModifier(1.2f).statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 200, 1), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION, 600, 0), 1.0f).alwaysEdible().build();
    ...
    public static final FoodComponent GOLDEN_BREAD = new FoodComponent.Builder().nutrition(8).saturationModifier(1.2f).statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 200, 0), 1.0f).alwaysEdible().build();
